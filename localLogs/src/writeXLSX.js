...
export const writeLog = async (data, filePath) =>{
  let xlsxData = [
    [{ value: 'boid', style: {} }, { value: 'body', style: {} }, { value: 'status', style: {} }, { value: 'message', style: {} }, { value: 'resultData', style: {} }],
  ];
  data.forEach(item =>{
    let cellStyle = item.status === 'error' ? {fill: { fgColor: { rgb: 'FF0000' } }, alignment: { wrapText: true, vertical:'top' } } : {alignment: { wrapText: true, vertical:'top' }};
    xlsxData.push([
